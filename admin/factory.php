...
<?php include_once 'include/navbar.php';?>  
        <div class="content">
            ...
            <div class="top">
                <p class="page-title"><i class="fa fa-info-circle fa-fw"></i> Factory</p>
                <ol class="breadcrumb">
            ...
            <div class="main-body">
                 <?php
                    if(isset($_POST['usubmit'])){
                        ...
                        if(mysql_query("UPDATE ".$prefix."factory SET ".$query)) //insert all text info
                            echo '<p class="alert alert-success"><i class="fa fa-check fa-fw"></i> Factory information Updated successfully.</p>';
                        else { 
                    ...
                    <div class="panel-body">
                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">                            
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <TEXTAREA type="text" class="form-control" name="description" id="description" maxlength="255" placeholder="Enter short description " required><?=anything('factory','description',1)?></TEXTAREA>
                                </div>
                            </div> 
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Video Link</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="link" id="" value="<?=anything('factory','link',1)?>" maxlength="" placeholder="Enter Video Link " required>
                                </div>
                            </div>                                    
                            <hr>
