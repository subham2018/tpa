        ...
        <div class="content">
            ...
            <div class="main-body">
                ...
                if(isset($_POST['submit'])){
                    ...
                    if(mysqli_query($link,"INSERT INTO ".$prefix."procat SET ".$query)) //insert all text info
                ...
                if(isset($_POST['usubmit'])){
                    ...
                    if(mysqli_query($link,"UPDATE ".$prefix."procat SET ".$query."WHERE id='".$_POST['bid']."'")) //insert all text info
                ...
                if(isset($_GET['del'])){
                    ...
                    if(mysqli_query($link,"DELETE FROM ".$prefix."procat WHERE id=".variable_check($_GET['del']))){ //delete info
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table id="Service_list" class="table table-hover table-bordered table-condensed" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php
                                $select=mysqli_query($link,"SELECT * FROM ".$prefix."procat");
