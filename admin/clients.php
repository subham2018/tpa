...
<?php include_once 'include/navbar.php';?>  
        <div class="content">
            ...
            <div class="top">
                <p class="page-title"><i class="fa fa-image fa-fw"></i>Clients</p>
                <ol class="breadcrumb">
     ...
     <div class="main-body">
                ...
                if(isset($_POST['submit'])){
                    ...
                    if(mysql_query("INSERT INTO ".$prefix."clients SET ".$query)) //insert all text info
                ...
                if(isset($_POST['usubmit'])){
                    ...
                    if(mysql_query("UPDATE ".$prefix."clients SET ".$query."WHERE id='".$_POST['bid']."'")) //insert all text info
                ...
                if(isset($_GET['del'])){
                    ...
                    if(mysql_query("DELETE FROM ".$prefix."clients WHERE id=".variable_check($_GET['del']))){ //delete info

                        mysql_query("DELETE FROM ".$prefix."clients WHERE `cat_id`=".variable_check($_GET['del']));
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table id="Category_list" class="table table-hover table-bordered table-condensed" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php
                                $select=mysql_query("SELECT * FROM ".$prefix."clients");
