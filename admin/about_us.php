...
<?php include_once 'include/navbar.php';?>	
        <div class="content">
            ...
            <div class="top">
            	<p class="page-title"><i class="fa fa-info fa-fw"></i> About Us Pages</p>
                <ol class="breadcrumb">
					<li><a href="index.php">Dashboard</a></li>
                    <li class="active">About Us Pages</li>
                </ol>
            </div>
            <!--main content start-->
            <div class="main-body">
                ...
                if(isset($_POST['submit'])){
                    ...
                    if(mysql_query("INSERT INTO ".$prefix."about_us SET `title`='".$_POST['title']."',`content`='".$_POST['content']."',`status`='".$_POST['status']."'")) //insert all text info
                        echo '<p class="alert alert-success"><i class="fa fa-check fa-fw"></i> About us information successfully added.</p>';
                    else { 
                        echo '<p class="alert alert-danger"><i class="fa fa-warning fa-fw"></i> Sorry! There is an error while uploading details!</p>';   
                    }
                }
                ...
                if(isset($_POST['usubmit'])){
                    ...
                    if(!isset($error) && mysql_query("UPDATE ".$prefix."about_us SET ".$query." WHERE id=".$_POST['pid'])) //insert all text info
                        echo '<p class="alert alert-success"><i class="fa fa-check fa-fw"></i> About us information successfully updated.</p>';
                    else { 
                ...
                <div class="panel panel-default" id="addnew" style="display:none;">
                	<div class="panel-heading">
                    	<div class="panel-title"><i class="fa fa-plus fa-fw"></i> Add About Us Information</div>
                    </div>
            	...
            	<div class="panel panel-default">
                	<div class="panel-heading">
                    	<div class="panel-title"><i class="fa fa-list fa-fw"></i>About Us Information List <button onClick="$('#addnew').show('slow')" class="btn btn-sm btn-primary pull-right">Add New</button></div>
                    </div>
                    <div class="panel-body">
                    	<table id="Page_list" class="table table-hover table-bordered table-condensed" cellspacing="0" width="100%">
							...
							<tbody>
                            	<?php
								$select=mysql_query("SELECT * FROM ".$prefix."about_us");
								while($row=mysql_fetch_object($select)){
								?>
                                <tr>
                                	<td><?=$row->title?></td>
                                    <td><a href="about_inner.php?id=<?=$row->id?>" target="_blank">about_inner.php?id=<?=$row->id?></a></td>
                                    <td><i class="fa fa-<?=$row->status==0? 'close':'check'?> fa-fw"></i></td>
                                    <td>
                                        <button class="btn btn-default btn-sm" onClick="getAbout(<?=$row->id?>)"><i class="fa fa-eye fa-fw"></i>/<i class="fa fa-pencil fa-fw"></i></button>
                                        <?php if($row->id > 10){?>
                  ...
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">View / Edit About Us Information</h4>
                        </div>
