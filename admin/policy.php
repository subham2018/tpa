...
<?php include_once 'include/navbar.php';?>  
        <div class="content">
            ...
            <div class="top">
                <p class="page-title"><i class="fa fa-info-circle fa-fw"></i> Quality Policy</p>
                <ol class="breadcrumb">
            ...
            <div class="main-body">
                 <?php
                    if(isset($_POST['usubmit'])){
                        ...
                        if(mysql_query("UPDATE ".$prefix."policy SET ".$query)) //insert all text info
                            echo '<p class="alert alert-success"><i class="fa fa-check fa-fw"></i> Quality Policy Updated successfully.</p>';
                        else { 
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="panel-title"><i class="fa fa-pencil fa-fw"></i> Edit Quality Policy</div>
                    </div>
                    <div class="panel-body">
                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">                            
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <TEXTAREA type="text" class="form-control" name="description" id="description" maxlength="255" placeholder="Enter short description " required><?=anything('policy','description',1)?></TEXTAREA>
                                </div>
                            </div>                                    
                            <hr>
