            ...
            <div class="main-body">
                <?php
                    ...
                    if(!empty($_FILES['image']['tmp_name']) && is_uploaded_file( $_FILES['image']['tmp_name'] )){
                        ...
                        mysqli_query($link,"INSERT INTO ".$prefix."news SET ".$query);
                ...
                if(isset($_POST['usubmit'])){
                    ...
                    if(!empty($_FILES['image']['tmp_name']) && is_uploaded_file( $_FILES['image']['tmp_name'] )){
                        ...
                        if($image_res != false && resize_image($image_res, $target_file, $image_type, 1336, $image_width, $image_height,  $_POST['qa'], false, true)){
                            ...
                            @unlink(UPLOAD_IMG_PATH . anything('news','image',$_POST['bid']));
                            @unlink(UPLOAD_TMB_IMG_PATH . anything('news','image',$_POST['bid']));


                            mysqli_query($link,"UPDATE ".$prefix."news SET `image`='$fbasename' WHERE `id`=".$_POST['bid']);
                        }
                        else {
                            $error='1';
                            unlink($target_file);
                    ...
                    if(!isset($error)&& mysqli_query($link,"UPDATE ".$prefix."news SET ".$query." WHERE id=".$_POST['bid'])){//insert all text info
                    ...
                    if(mysqli_query($link,"DELETE FROM ".$prefix."news WHERE id=".variable_check($_GET['del']))){ //delete info
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table id="gallery_list" class="table table-hover table-bordered table-condensed" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php
                                $select=mysqli_query($link,"SELECT * FROM ".$prefix."news");
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-default btn-sm" onClick="getNews(<?=$row->id?>)"><i class="fa fa-eye fa-fw"></i>/<i class="fa fa-pencil fa-fw"></i></button>
