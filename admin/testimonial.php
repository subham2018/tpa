...
<?php include_once 'include/navbar.php';?>  
        <div class="content">
            ...
            <div class="top">
                <p class="page-title"><i class="fa fa-users"></i> Testimonial</p>
                <ol class="breadcrumb">
               ...
               //Projects Save
                if(isset($_POST['submit'])){
                    ...
                    if(!empty($_FILES['image']['tmp_name']) && is_uploaded_file( $_FILES['image']['tmp_name'] )){
                        ...
                        //optimize and save
                        if($image_res != false && crop_image_square($image_res, $target_tmb_file, $image_type, 320, $image_width, $image_height,  $_POST['qa'])){
                            ...
                            mysqli_query($link,"INSERT INTO ".$prefix."testimonial SET ".$query);
                            echo '<p class="alert alert-success"><i class="fa fa-check fa-fw"></i> testimonial Added successfully.</p>';
                            echo mysqli_error();
                        }
                        else {
                            unlink($target_file);
                ...
                if(isset($_POST['usubmit'])){
                    ...
                    if(!empty($_FILES['image']['tmp_name']) && is_uploaded_file( $_FILES['image']['tmp_name'] )){
                        ...
                        if($image_res != false && crop_image_square($image_res, $target_tmb_file, $image_type, 320, $image_width, $image_height,  $_POST['qa'])){
                            ...
                            //@unlink(UPLOAD_IMG_PATH . anything('testimonial','image',$_POST['bid']));
                            @unlink(UPLOAD_TMB_IMG_PATH . anything('testimonial','image',$_POST['bid']));


                            mysqli_query($link,"UPDATE ".$prefix."testimonial SET `image`='$fbasename' WHERE `id`=".$_POST['bid']);
                        }
                        else {
                            $error='1';
                            unlink($target_file);
                    ...
                    if(!isset($error) && mysqli_query($link,"UPDATE ".$prefix."testimonial SET ".$query." WHERE id=".$_POST['bid'])) //insert all text info
                    ...
                    if(isset($_GET['del'])){
                     ...
                     $img=anything('testimonial','image',$_GET['del']);
                    if(mysqli_query($link,"DELETE FROM ".$prefix."testimonial WHERE id=".variable_check($_GET['del']))){ //delete info
                    ...
                    <div class="panel-body">
                        <form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"  maxlength="255" name="name" placeholder="Enter name " required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text" class="form-control" name="msg" id="msg" placeholder="Enter description" required></textarea>
                                </div>
                            </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="panel-title"><i class="fa fa-list fa-fw"></i> Testimonial List <button onClick="$('#addnew').show('slow')" class="btn btn-sm btn-primary pull-right">Add New</button></div>
                    </div>
                    <div class="panel-body">
                        <table id="Service_list" class="table table-hover table-bordered table-condensed" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php
                                $select=mysqli_query($link,"SELECT * FROM ".$prefix."testimonial");
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-default btn-sm" onClick="getFeedback(<?=$row->id?>)"><i class="fa fa-eye fa-fw"></i>/<i class="fa fa-pencil fa-fw"></i></button>
                                        <a class="btn btn-danger btn-sm" href="testimonial.php?del=<?=$row->id?>"><i class="fa fa-trash fa-fw"></i></a>
                                    </td>
                                </tr>
                                <?php }?>
                            </tbody>
                  ...
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">View / Edit Service</h4>
                        </div>
                        <div class="modal-body clearfix">
                           <div class="row">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Name<font color="red">*</font></label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"  maxlength="255" name="name" id="name" placeholder="Enter Name" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Description<font color="red">*</font></label>
                                <div class="col-sm-10">
                                    <textarea type="text" class="form-control" name="msg" id="msg1" placeholder="Enter description" required></textarea>
                                </div>
                            </div>
