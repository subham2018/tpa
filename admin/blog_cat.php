...
<?php include_once 'include/navbar.php';?>  
        <div class="content">
            ...
            <div class="top">
                <p class="page-title"><i class="fa fa-image fa-fw"></i>Blog Category</p>
                <ol class="breadcrumb">
     ...
     <div class="main-body">
                ...
                if(isset($_POST['submit'])){
                    ...
                    if(mysql_query("INSERT INTO ".$prefix."blog_cat SET ".$query)) //insert all text info
                ...
                if(isset($_POST['usubmit'])){
                    ...
                    if(mysql_query("UPDATE ".$prefix."blog_cat SET ".$query."WHERE id='".$_POST['bid']."'")) //insert all text info
                ...
                if(isset($_GET['del'])){
                    ...
                    if(mysql_query("DELETE FROM ".$prefix."blog_cat WHERE id=".variable_check($_GET['del']))){ //delete info

                        mysql_query("DELETE FROM ".$prefix."blog WHERE `cat_id`=".variable_check($_GET['del']));
     ...
     <!--add new-->
                <div class="panel panel-default" id="addnew" style="display:none;">
                    <div class="panel-heading">
                        <div class="panel-title"><i class="fa fa-plus fa-fw"></i> Add Article category Manually</div>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="panel-title"><i class="fa fa-list fa-fw"></i>Article Category List <button onClick="$('#addnew').show('slow')" class="btn btn-sm btn-primary pull-right">Add New Manually</button></div>
                    </div>
                    <div class="panel-body">
