...
<?php include_once 'include/navbar.php';?>	
        <div class="content">
            ...
            <div class="top">
            	<p class="page-title"><i class="fa fa-tty fa-fw"></i> Membership Form</p>
                <ol class="breadcrumb">
            ...
            <div class="main-body">
				...
				if(isset($_GET['del'])){
                    //delete Training Reg
					if(mysqli_query($link,"DELETE FROM ".$prefix."membership WHERE id=".variable_check($_GET['del']))) //delete info
						echo '<p class="alert alert-success"><i class="fa fa-check fa-fw"></i> Contact Query Succesfully Deleted.</p>';
					else echo '<p class="alert alert-danger"><i class="fa fa-warning fa-fw"></i> Sorry! There Is An Error While Deleting Contact Query!</p>';
				}
				?>
            	...
            	<div class="panel panel-default">
                	<div class="panel-heading">
                    	<div class="panel-title"><i class="fa fa-list fa-fw"></i> Memebership Form List</div>
                    </div>
                    <div class="panel-body">
                    	<table id="query_list" class="table table-hover table-bordered table-condensed" cellspacing="0" width="100%">
							...
							<tbody>
                            	<?php
								$select=mysqli_query($link,"SELECT * FROM ".$prefix."membership");
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-danger btn-sm" href="contact-query.php?del=<?=$row->id?>"><i class="fa fa-trash fa-fw"></i></a>
                                    </td>
								</tr>
                                <?php }?>
                            </tbody>
