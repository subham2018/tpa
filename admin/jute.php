...
<?php include_once 'include/navbar.php';?>  
        <div class="content">
            ...
            <div class="top">
                <p class="page-title"><i class="fa fa-info-circle fa-fw"></i> About Jute</p>
                <ol class="breadcrumb">
                    <li><a href="index.php">Dashboard</a></li>
                    <li>About</li>
                    <li class="active">About Jute</li>
                </ol>
            </div>
            <!--main content start-->
            <div class="main-body">
                 <?php
                    if(isset($_POST['usubmit'])){
                        ...
                        if(mysql_query("UPDATE ".$prefix."about_jute SET ".$query)) //insert all text info
                            echo '<p class="alert alert-success"><i class="fa fa-check fa-fw"></i> About Jute details Updated successfully.</p>';
                        else { 
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="panel-title"><i class="fa fa-pencil fa-fw"></i> Edit About Jute</div>
                    </div>
                    <div class="panel-body">
                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">                            
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <TEXTAREA type="text" class="form-control" name="description" id="description" maxlength="255" placeholder="Enter short description " required><?=anything('about_jute','description',1)?></TEXTAREA>
                                </div>
                            </div>                                    
                            <hr>
