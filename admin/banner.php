...
<?php include_once 'include/navbar.php';?>	
        <div class="content">
            ...
            <div class="top">
            	<p class="page-title"><i class="fa fa-image fa-fw"></i> Banner</p>
                <ol class="breadcrumb">
            ...
            <div class="main-body">
                ...
                if(isset($_POST['submit'])){
                    ...
                    if(!empty($_FILES['side_img']['tmp_name']) && is_uploaded_file( $_FILES['side_img']['tmp_name'] )){
                        ...
                        if($image_res != false && resize_image($image_res, $target_file, $image_type, 768, $image_width, $image_height,  $_POST['qa'], true, false)){
                            ...
                            mysqli_query($link,"INSERT INTO ".$prefix."banner SET ".$query);
                ...
                if(isset($_POST['usubmit'])){
                    ...
                    if(!isset($error) && mysqli_query($link,"UPDATE ".$prefix."banner SET ".$query." WHERE id=".$_POST['bid'])) //insert all text info
                        echo '<p class="alert alert-success"><i class="fa fa-check fa-fw"></i> Banner information successfully updated.</p>';
                    else { 
				...
				if(isset($_GET['del'])){
                    //delete banner
                    $img = anything('banner','side_img',$_GET['del']);
					if(mysqli_query($link,"DELETE FROM ".$prefix."banner WHERE id=".variable_check($_GET['del']))) {//delete info
                        @unlink(UPLOAD_IMG_PATH . $img);
						echo '<p class="alert alert-success"><i class="fa fa-check fa-fw"></i> Banner successfully deleted.</p>';
                    }
					else echo '<p class="alert alert-danger"><i class="fa fa-warning fa-fw"></i> Sorry! There is an error while deleting banner information record!</p>';
				}
				?>
                ...
                <div class="panel panel-default" id="addnew" style="display:none;">
                	<div class="panel-heading">
                    	<div class="panel-title"><i class="fa fa-plus fa-fw"></i> Add Banner</div>
                    </div>
                    <div class="panel-body">
                        ...
                        <form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control"  maxlength="255" name="title" placeholder="Enter banner title" required>
                                </div>
                            </div>
            	...
            	<div class="panel panel-default">
                	<div class="panel-heading">
                    	<div class="panel-title"><i class="fa fa-list fa-fw"></i> Banner List <button onClick="$('#addnew').show('slow')" class="btn btn-sm btn-primary pull-right">Add Record</button></div>
                    </div>
                    <div class="panel-body">
                    	<table id="banner_list" class="table table-hover table-bordered table-condensed" cellspacing="0" width="100%">
                        	<thead>
                                <tr>
                                    <th>Title</th>
                                    <th>Image</th>
							...
							<tbody>
                                ...
                                <tr>
                                	<td><?=$row->title?></td>
                                    <td><img src="<?=UPLOAD_IMG_PATH.anything('banner','side_img',$row->id)?>" height="20px"></td>
                                    <td>
                                        <button class="btn btn-default btn-sm" onClick="getBanner(<?=$row->id?>)"><i class="fa fa-eye fa-fw"></i>/<i class="fa fa-pencil fa-fw"></i></button>
                                        <a class="btn btn-danger btn-sm" href="banner.php?del=<?=$row->id?>"><i class="fa fa-trash fa-fw"></i></a>
                                    </td>
								</tr>
                                <?php }?>
                            </tbody>
                  ...
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">View / Edit Banner</h4>
                        </div>
                                ...
                                <div class="col-sm-8">
                                     <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label>Title*</label>
                                            <div>
                                                <input type="text" class="form-control"  maxlength="255" id="title" name="title" placeholder="Enter banner title" required>
                                            </div>
                                        </div>
