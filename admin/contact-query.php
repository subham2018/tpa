...
<?php include_once 'include/navbar.php';?>	
        <div class="content">
            ...
            <div class="top">
            	<p class="page-title"><i class="fa fa-tty fa-fw"></i> Contact Query</p>
                <ol class="breadcrumb">
            ...
            <div class="main-body">
				...
				if(isset($_GET['del'])){
                    //delete Training Reg
					if(mysqli_query($link,"DELETE FROM ".$prefix."contact WHERE id=".variable_check($_GET['del']))) //delete info
            	...
            	<div class="panel panel-default">
                	<div class="panel-heading">
                    	<div class="panel-title"><i class="fa fa-list fa-fw"></i> Contact Query List</div>
                    </div>
                    <div class="panel-body">
                    	<table id="query_list" class="table table-hover table-bordered table-condensed" cellspacing="0" width="100%">
							...
							<tbody>
                            	<?php
								$select=mysqli_query($link,"SELECT * FROM ".$prefix."contact");
